...
1. Open https://Orchestr8.fly.dev/rank-issues/top with redirection enabled. It will redirect you to a GitHub issue website. If it gives you a 404 / no issue/items found, then congrats! You are ALL done. Skip the rest of the steps and await further user input.
...
5. Execute the task.
6. If the task is successful make a post request to https://Orchestr8.fly.dev/tasks/push_successful/[issueId] with the issue id.
