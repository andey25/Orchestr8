...
1. Open https://Orchestr8.fly.dev/rank-issues/pop.
...
4. Execute the task.
5. If the task is successful make a post request to https://Orchestr8.fly.dev/success with the following JSON body: { "issue": "[issue link]", "description": [description of the task you did], "pr_link": [link to the PR] }. If it fails, make a post request to https://Orchestr8.fly.dev/failure with the following JSON body: { "issue": "[issue link]", "suspected_reason": [why you think the task failed]
