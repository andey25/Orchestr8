...
4. Execute the task.
5. If the task is successful make a post request to https://Orchestr8.fly.dev/success with the following JSON body: { "issue": "[issue link]", "description": "[description of the task you did] }
6. If you encounter any installation issues, pip install those packages.
7. If unsuccessful, make a post request to the https://Orchestr8.fly.dev/failure with a detailed log of everything you did and the errors you encountered. Include what you typed in the terminal/code you changed. now make a post request to Orchestr8.fly.dev/failure/ and pass in the issue url, the playbook used, and your reasoning for everything that went wrong.
